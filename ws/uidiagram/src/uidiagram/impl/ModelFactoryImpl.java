 ...
 * </p>
 * <ul>
 *   <li>{@link uidiagram.impl.ModelFactoryImpl#getLstUI_Diagrams <em>Lst UI Diagrams</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ModelFactoryImpl extends EObjectImpl implements ModelFactory {
	...
	public EList<UI_Diagram> getLstUI_Diagrams() {
		if (lstUI_Diagrams == null) {
			lstUI_Diagrams = new EObjectContainmentEList<UI_Diagram>(UI_Diagram.class, this, UidiagramPackage.MODEL_FACTORY__LST_UI_DIAGRAMS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UidiagramPackage.MODEL_FACTORY__LST_UI_DIAGRAMS:
