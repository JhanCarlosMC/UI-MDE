...
import uidiagram.diagram.edit.policies.GroupGroupLstChildModelElementsCompartmentCanonicalEditPolicy;
import uidiagram.diagram.edit.policies.GroupGroupLstChildModelElementsCompartmentItemSemanticEditPolicy;
...
public class GroupGroupLstChildModelElementsCompartmentEditPart extends ShapeCompartmentEditPart {
	...
	*/
	public String getCompartmentName() {
		return Messages.GroupGroupLstChildModelElementsCompartmentEditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new GroupGroupLstChildModelElementsCompartmentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(UidiagramVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new GroupGroupLstChildModelElementsCompartmentCanonicalEditPolicy());
	}
