...
import uidiagram.diagram.edit.policies.SpinBoxItemSemanticEditPolicy;
import uidiagram.diagram.part.UidiagramVisualIDRegistry;

/**
 * @generated
 */
public class SpinBoxEditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public SpinBoxEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new SpinBoxItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof SpinBoxNameEditPart) {
			((SpinBoxNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureSpinBoxLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(SpinBoxNameEditPart.VISUAL_ID));
	}
