...
import uidiagram.diagram.edit.policies.LabelFrame2ItemSemanticEditPolicy;
import uidiagram.diagram.part.UidiagramVisualIDRegistry;

/**
 * @generated
 */
public class LabelFrame2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public LabelFrame2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new LabelFrame2ItemSemanticEditPolicy());
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new LabelFrameFigure();
	}

	/**
	* @generated
	*/
	public LabelFrameFigure getPrimaryShape() {
		return (LabelFrameFigure) primaryShape;
	}
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof LabelFrameName2EditPart) {
			((LabelFrameName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureLabelFrameLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(LabelFrameName2EditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class LabelFrameFigure extends RoundedRectangle {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureLabelFrameLabelFigure;

		/**
		 * @generated
		 */
		public LabelFrameFigure() {
		...
		private void createContents() {
			...
			fFigureLabelFrameLabelFigure = new WrappingLabel();

			fFigureLabelFrameLabelFigure.setText("LabelFrame");

			this.add(fFigureLabelFrameLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureLabelFrameLabelFigure() {
			return fFigureLabelFrameLabelFigure;
		}
