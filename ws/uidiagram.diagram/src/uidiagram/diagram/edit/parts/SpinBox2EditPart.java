...
import uidiagram.diagram.edit.policies.SpinBox2ItemSemanticEditPolicy;
import uidiagram.diagram.part.UidiagramVisualIDRegistry;

/**
 * @generated
 */
public class SpinBox2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public SpinBox2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new SpinBox2ItemSemanticEditPolicy());
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new SpinBoxFigure();
	}

	/**
	* @generated
	*/
	public SpinBoxFigure getPrimaryShape() {
		return (SpinBoxFigure) primaryShape;
	}
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof SpinBoxName2EditPart) {
			((SpinBoxName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureSpinBoxLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(SpinBoxName2EditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class SpinBoxFigure extends RoundedRectangle {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureSpinBoxLabelFigure;

		/**
		 * @generated
		 */
		public SpinBoxFigure() {
		...
		private void createContents() {
			...
			fFigureSpinBoxLabelFigure = new WrappingLabel();

			fFigureSpinBoxLabelFigure.setText("SpinBox");

			this.add(fFigureSpinBoxLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureSpinBoxLabelFigure() {
			return fFigureSpinBoxLabelFigure;
		}
