...
import uidiagram.diagram.edit.policies.Notebook2ItemSemanticEditPolicy;
import uidiagram.diagram.part.UidiagramVisualIDRegistry;

/**
 * @generated
 */
public class Notebook2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public Notebook2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Notebook2ItemSemanticEditPolicy());
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new NotebookFigure();
	}
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof NotebookName2EditPart) {
			((NotebookName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureNotebookLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(NotebookName2EditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class NotebookFigure extends RoundedRectangle {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureNotebookLabelFigure;
		...
		private void createContents() {
			...
			fFigureNotebookLabelFigure = new WrappingLabel();

			fFigureNotebookLabelFigure.setText("Notebook");

			this.add(fFigureNotebookLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureNotebookLabelFigure() {
			return fFigureNotebookLabelFigure;
		}
