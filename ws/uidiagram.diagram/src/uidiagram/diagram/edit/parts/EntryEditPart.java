...
import uidiagram.diagram.edit.policies.EntryItemSemanticEditPolicy;
...
public class EntryEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof EntryNameEditPart) {
			((EntryNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureEntryLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(EntryNameEditPart.VISUAL_ID));
	}
