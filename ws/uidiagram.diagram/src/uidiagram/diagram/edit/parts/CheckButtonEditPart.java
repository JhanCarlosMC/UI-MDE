...
import uidiagram.diagram.edit.policies.CheckButtonItemSemanticEditPolicy;
import uidiagram.diagram.part.UidiagramVisualIDRegistry;

/**
 * @generated
 */
public class CheckButtonEditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public CheckButtonEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new CheckButtonItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CheckButtonNameEditPart) {
			((CheckButtonNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureCheckButtonLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(CheckButtonNameEditPart.VISUAL_ID));
	}
