...
import uidiagram.diagram.edit.policies.Separator2ItemSemanticEditPolicy;
import uidiagram.diagram.part.UidiagramVisualIDRegistry;

/**
 * @generated
 */
public class Separator2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public Separator2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Separator2ItemSemanticEditPolicy());
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new SeparatorFigure();
	}

	/**
	* @generated
	*/
	public SeparatorFigure getPrimaryShape() {
		return (SeparatorFigure) primaryShape;
	}
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof SeparatorName2EditPart) {
			((SeparatorName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureSeparatorLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(SeparatorName2EditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class SeparatorFigure extends RoundedRectangle {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureSeparatorLabelFigure;
		...
		private void createContents() {
			...
			fFigureSeparatorLabelFigure = new WrappingLabel();

			fFigureSeparatorLabelFigure.setText("Separator");

			this.add(fFigureSeparatorLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureSeparatorLabelFigure() {
			return fFigureSeparatorLabelFigure;
		}
