...
import uidiagram.diagram.edit.policies.CheckButton2ItemSemanticEditPolicy;
import uidiagram.diagram.part.UidiagramVisualIDRegistry;

/**
 * @generated
 */
public class CheckButton2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public CheckButton2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new CheckButton2ItemSemanticEditPolicy());
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new CheckButtonFigure();
	}

	/**
	* @generated
	*/
	public CheckButtonFigure getPrimaryShape() {
		return (CheckButtonFigure) primaryShape;
	}
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CheckButtonName2EditPart) {
			((CheckButtonName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureCheckButtonLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(CheckButtonName2EditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class CheckButtonFigure extends RoundedRectangle {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureCheckButtonLabelFigure;

		/**
		 * @generated
		 */
		public CheckButtonFigure() {
		...
		private void createContents() {
			...
			fFigureCheckButtonLabelFigure = new WrappingLabel();

			fFigureCheckButtonLabelFigure.setText("CheckButton");

			this.add(fFigureCheckButtonLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureCheckButtonLabelFigure() {
			return fFigureCheckButtonLabelFigure;
		}
