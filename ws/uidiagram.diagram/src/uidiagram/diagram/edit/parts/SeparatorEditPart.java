...
import uidiagram.diagram.edit.policies.SeparatorItemSemanticEditPolicy;
import uidiagram.diagram.part.UidiagramVisualIDRegistry;

/**
 * @generated
 */
public class SeparatorEditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public SeparatorEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new SeparatorItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof SeparatorNameEditPart) {
			((SeparatorNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureSeparatorLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(SeparatorNameEditPart.VISUAL_ID));
	}
