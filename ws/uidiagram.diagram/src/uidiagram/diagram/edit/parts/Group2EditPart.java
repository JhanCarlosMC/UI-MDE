...
public class Group2EditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof GroupGroupLstChildModelElementsCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getGroupLstChildModelElementsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((GroupGroupLstChildModelElementsCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof GroupGroupLstChildModelElementsCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getGroupLstChildModelElementsCompartmentFigure();
			pane.remove(((GroupGroupLstChildModelElementsCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof GroupGroupLstChildModelElementsCompartment2EditPart) {
