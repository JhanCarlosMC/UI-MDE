...
public class GroupEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof GroupGroupLstChildModelElementsCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getGroupLstChildModelElementsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((GroupGroupLstChildModelElementsCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof GroupGroupLstChildModelElementsCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getGroupLstChildModelElementsCompartmentFigure();
			pane.remove(((GroupGroupLstChildModelElementsCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof GroupGroupLstChildModelElementsCompartmentEditPart) {
