...
import uidiagram.diagram.edit.policies.ScrollBarItemSemanticEditPolicy;
import uidiagram.diagram.part.UidiagramVisualIDRegistry;

/**
 * @generated
 */
public class ScrollBarEditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public ScrollBarEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ScrollBarItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ScrollBarNameEditPart) {
			((ScrollBarNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureScrollBarLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(ScrollBarNameEditPart.VISUAL_ID));
	}
