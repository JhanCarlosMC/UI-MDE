...
import uidiagram.diagram.edit.policies.RadioButtonItemSemanticEditPolicy;
...
public class RadioButtonEditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new RadioButtonItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof RadioButtonNameEditPart) {
			((RadioButtonNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureRadioButtonLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(RadioButtonNameEditPart.VISUAL_ID));
	}
