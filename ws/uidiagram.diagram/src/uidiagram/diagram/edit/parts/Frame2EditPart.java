...
import uidiagram.diagram.edit.policies.Frame2ItemSemanticEditPolicy;
import uidiagram.diagram.part.UidiagramVisualIDRegistry;

/**
 * @generated
 */
public class Frame2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public Frame2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Frame2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof FrameName2EditPart) {
			((FrameName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureFrameLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(FrameName2EditPart.VISUAL_ID));
	}
