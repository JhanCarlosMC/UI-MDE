 ...
 * @generated
 */
public class CheckButtonNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CheckButtonNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UidiagramParserProvider.getParser(UidiagramElementTypes.CheckButton_3043, getParserElement(),
					UidiagramVisualIDRegistry.getType(uidiagram.diagram.edit.parts.CheckButtonNameEditPart.VISUAL_ID));
		}
		return parser;
	}
