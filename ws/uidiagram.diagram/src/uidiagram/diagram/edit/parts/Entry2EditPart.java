...
import uidiagram.diagram.edit.policies.Entry2ItemSemanticEditPolicy;
import uidiagram.diagram.part.UidiagramVisualIDRegistry;

/**
 * @generated
 */
public class Entry2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public Entry2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Entry2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof EntryName2EditPart) {
			((EntryName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureEntryLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(EntryName2EditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class EntryFigure extends RoundedRectangle {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureEntryLabelFigure;
		...
		private void createContents() {
			...
			fFigureEntryLabelFigure = new WrappingLabel();

			fFigureEntryLabelFigure.setText("Entry");

			this.add(fFigureEntryLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureEntryLabelFigure() {
			return fFigureEntryLabelFigure;
		}
