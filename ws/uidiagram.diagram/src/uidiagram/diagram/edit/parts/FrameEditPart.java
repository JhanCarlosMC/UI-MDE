...
import uidiagram.diagram.edit.policies.FrameItemSemanticEditPolicy;
...
public class FrameEditPart extends ShapeNodeEditPart {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(FrameNameEditPart.VISUAL_ID));
	}
