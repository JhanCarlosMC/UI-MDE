...
public class UserInterfaceEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof UserInterfaceUserInterfaceLstModelElementsCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getUserInterfaceLstModelElementsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((UserInterfaceUserInterfaceLstModelElementsCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof UserInterfaceUserInterfaceLstModelElementsCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getUserInterfaceLstModelElementsCompartmentFigure();
			pane.remove(((UserInterfaceUserInterfaceLstModelElementsCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof UserInterfaceUserInterfaceLstModelElementsCompartmentEditPart) {
