...
import uidiagram.diagram.edit.policies.RadioButton2ItemSemanticEditPolicy;
...
public class RadioButton2EditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new RadioButton2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof RadioButtonName2EditPart) {
			((RadioButtonName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureRadioButtonLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(RadioButtonName2EditPart.VISUAL_ID));
	}
