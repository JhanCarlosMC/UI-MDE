...
import uidiagram.diagram.edit.policies.MenuButton2ItemSemanticEditPolicy;
import uidiagram.diagram.part.UidiagramVisualIDRegistry;

/**
 * @generated
 */
public class MenuButton2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public MenuButton2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new MenuButton2ItemSemanticEditPolicy());
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new MenuButtonFigure();
	}

	/**
	* @generated
	*/
	public MenuButtonFigure getPrimaryShape() {
		return (MenuButtonFigure) primaryShape;
	}
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof MenuButtonName2EditPart) {
			((MenuButtonName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureMenuButtonLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(MenuButtonName2EditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class MenuButtonFigure extends RoundedRectangle {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureMenuButtonLabelFigure;

		/**
		 * @generated
		 */
		public MenuButtonFigure() {
		...
		private void createContents() {
			...
			fFigureMenuButtonLabelFigure = new WrappingLabel();

			fFigureMenuButtonLabelFigure.setText("MenuButton");

			this.add(fFigureMenuButtonLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureMenuButtonLabelFigure() {
			return fFigureMenuButtonLabelFigure;
		}
