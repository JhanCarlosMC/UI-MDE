...
import uidiagram.diagram.edit.policies.MenuButtonItemSemanticEditPolicy;
import uidiagram.diagram.part.UidiagramVisualIDRegistry;

/**
 * @generated
 */
public class MenuButtonEditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public MenuButtonEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new MenuButtonItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof MenuButtonNameEditPart) {
			((MenuButtonNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureMenuButtonLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(MenuButtonNameEditPart.VISUAL_ID));
	}
