 ...
 * @generated
 */
public class TreeviewTreeviewLstChildModelElementsCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return UidiagramPackage.eINSTANCE.getGraphicalContainer_LstChildModelElements();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getTreeviewTreeviewLstChildModelElementsCompartment_7005SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getTreeviewTreeviewLstChildModelElementsCompartment_7005SemanticChildren((View) getHost().getModel());
