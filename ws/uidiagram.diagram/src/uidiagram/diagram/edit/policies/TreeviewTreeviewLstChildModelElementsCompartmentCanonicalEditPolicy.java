 ...
 * @generated
 */
public class TreeviewTreeviewLstChildModelElementsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getTreeviewTreeviewLstChildModelElementsCompartment_7004SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getTreeviewTreeviewLstChildModelElementsCompartment_7004SemanticChildren((View) getHost().getModel());
