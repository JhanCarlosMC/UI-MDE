 ...
 * @generated
 */
public class Entry2CreateCommand extends EditElementCommand {

	/**
	* @generated
	*/
	public Entry2CreateCommand(CreateElementRequest req) {
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		Entry newElement = UidiagramFactory.eINSTANCE.createEntry();
